app.addCommand(
    'settings',
    {
        ...
        help: 'User settings<br />Usage: settings [command] [[key] [value]]...<br />' +
        'Available commands:<br />set - Sets a new value for given key<br />Example: settings set skin default',
        secured: false,
        isAvailable: true,
