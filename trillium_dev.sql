...
CREATE TABLE IF NOT EXISTS `boards` (
  ...
  `blotter` text NOT NULL,
  PRIMARY KEY (`name`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

-- Дамп данных таблицы trillium_development.boards: 1 rows
/*!40000 ALTER TABLE `boards` DISABLE KEYS */;
INSERT INTO `boards` (`name`, `summary`, `hidden`, `captcha`, `bump_limit`, `max_file_size`, `images_per_post`, `thumb_width`, `pages`, `threads_per_page`, `ip_seconds_limit`, `blotter`) VALUES
	('b', 'Random', 0, 0, 0, 20971520, 2, 64, 1, 2, 0, '');
